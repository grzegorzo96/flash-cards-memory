...
Testowanie:
- Vitest - framework do testów jednostkowych i integracyjnych w TypeScript
...
- Playwright - framework do testów end-to-end (E2E), testowanie pełnych ścieżek użytkownika
- axe-core / jest-axe - testy dostępności (a11y)
